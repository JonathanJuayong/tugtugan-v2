...
G|-0-----0-----0--|  H  |--2-----0-----0--|
D|-0-----0-----0--|  E  |--0-----0-----0--|
A|-2--x--2--x--2--|  N  |--2--x--2--x--2--|
E|-3--x--3--x--3--|     |--3--x--3--x--3--|
        the two (x) means strum bass string. E and A only.
...
[Chorus]
 ...
 When she cries  <------------ Play the intro 2x for transition in verse 2.
...
When she cries   <------------ Play the intro for outro just once.
```